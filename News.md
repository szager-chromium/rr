**September 7, 2017**: [rr 5.0.0 released](https://github.com/mozilla/rr/releases/tag/4.5.0). This is a pretty big release that introduces trace portability and a stable trace format; see release notes.
